    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="Cuti.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>ABSENSI</h3>
                </a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                <a href="Cuti.html" class="navbar-brand d-flex d-lg-none me-4">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">TABLE ABSENSI</h6>
                        <a href="{{ route('cuti.create') }}"> <button type="button" class="btn btn-info  font-weight: bold; ">TAMBAH + </button>
                    </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Rahmat</td>
                                    <td>01 Jan 2045</td>
                                    <td> sadfadffadffafadf5</td>
                                    <td>Diterima</td>
                                    <td>
                                        <button type="button" class="btn btn-info m-2">Hadir</button>
                                      
                                        <button type="button" class="btn btn-primary m-2">Alpha </button>
                                    </td>
                                </tr>
                                <tr>
                                    <td>2</td>
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">Nama PT</a>, Copyright. 
                        </div>
                    </div>
                </div>
            </div>
