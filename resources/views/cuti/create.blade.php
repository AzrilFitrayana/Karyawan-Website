            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">FORM CUTI </h6>
                        <button type="button" class="btn btn-info  font-weight: bold; ">SIMPAN </button>
                    </div>
                    <form>
                        <div class="form-floating mb-3">
                            <input type="input" class="form-control" id="floatingPassword"
                                placeholder="Password">
                            <label for="floatingPassword">Nama Karyawan</label>
                        </div>
                       
                         <div class="form-floating mb-3">
                            <input type="date" class="form-control" id="floatingPassword"
                                placeholder="Password">
                            <label for="floatingPassword">Tanggal Cuti</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="date" class="form-control" id="floatingPassword"
                                placeholder="Password">
                            <label for="floatingPassword">Tanggal Selesai Cuti</label>
                        </div>
